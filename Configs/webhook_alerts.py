...
def enviar_alertas_inactividad(conn):
    ...
    for row in inactivos:
        ...
        # Evitar falsos positivos: no alertar si fue marcado hace < min_seconds
        ...
        # ejecutar_sql_fetch podría no aceptar params (dependiendo de tu implementación).
        # Para mayor compatibilidad intentamos una llamada simple si la anterior no devolvió datos.
        try:
            if ya:
                # si devolvió filas -> ya enviado hoy
                continue
        except Exception:
            # fallback: ejecutar consulta manualmente sin params
        ...
        try:
            ...
            # usar ejecutar_sql (o ejecutar_sql_reintento) para INSERT
